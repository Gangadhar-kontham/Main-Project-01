...
main = tkinter.Tk()
main.title("Predictive Modellinng for Credit Card Fraud Analysis") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Predictive Modellinng for Credit Card Fraud Analysis')
